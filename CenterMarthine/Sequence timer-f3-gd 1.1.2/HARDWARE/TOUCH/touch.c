...
u16 POINT_COLOR_= 0x0000;	//画笔颜色
u16 BACK_COLOR_ =0xFFFF;  //背景色 
...
{	    
	...
	LCD_Fast_DrawPoint(x,y,color);//中心点 
...
{	
	  ...
	  GPIO_InitTypeDef  GPIO_InitStructure;
		...
		//所以上拉之前,必须使能时钟.才能实现真正的上拉输出
	 	...
	 	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOE, ENABLE);	 //使能PB,PF端口时钟
	...
	//T_SCK
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;				
	 	...
	 	GPIO_SetBits(GPIOE,GPIO_Pin_4);//上拉    
	
		//T_MISO
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5;				 
	 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU; 		 //上拉输入
	 	GPIO_Init(GPIOE, &GPIO_InitStructure);
	 	GPIO_SetBits(GPIOE,GPIO_Pin_5);//上拉		
		...
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3|GPIO_Pin_6;				
	 	...
	 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	 	GPIO_Init(GPIOE, &GPIO_InitStructure);
	 	GPIO_SetBits(GPIOE, GPIO_Pin_3|GPIO_Pin_6);//上拉
		
		//T_PEN QIR
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;				 
	 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU; 		 //上拉输入
	 	GPIO_Init(GPIOE, &GPIO_InitStructure);
	 	GPIO_SetBits(GPIOE,GPIO_Pin_2);//上拉		
